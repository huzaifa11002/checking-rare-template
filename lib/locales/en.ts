export const en = {
    topbar: {
        english: "English",
        urdu: "Urdu",
        contactEmail: "contact@rarefoundation.com",
    ...
    footer: {
        brandText: "Dedicated to serving humanity through education, healthcare, and basic needs support. Our mission is to empower the underprivileged and create lasting change in Pakistan.",
    ...
    home: {
        hero: {
            ...
            title_name: "Rare",
            title_sub: "Foundation Trust",
            description: "Empowering the underprivileged across Pakistan with transparency, integrity, and dedicated humanitarian service since 2011.",
        ...
        donationBar: {
            selectAmount: "Select Donation Amount (PKR)",
        ...
        about: {
            tag: "About Foundation",
            title: "We are on a Mission to Serve the Helpless",
            description: "Rare Foundation Trust is a leading non-profit organization in Pakistan, dedicated to providing sustainable solutions to poverty through education, healthcare, and emergency relief. We work to uplift underprivileged communities by empowering individuals, supporting families, and responding to humanitarian needs with compassion and integrity.",
            discoverStory: "Discover Our Story",
            stats: {
                lives: "1M+ Targeted Lives Each Year",
                transparency: "100% Transparency in Funds",
                facilities: "Modern Educational Facilities",
                relief: "Nationwide Relief Networks",
                projects: "5+ Educational Projects",
                pumps: "100+ Handpumps Installed"
            },
            badge: {
        ...
        services: {
            ...
            description: "Empowering communities through sustainable welfare projects that address the core needs of humanity with transparency and dedication.",
        ...
        campaigns: {
            ...
            description: "Take part in our most pressing initiatives. Your immediate support can bring a significant change today.",
            viewGallery: "View Project Gallery",
            donateNow: "DONATE NOW",
            items: {
                food: {
                    title: "Daily Food Mission",
                    desc: "Feeding 500+ needy individuals every single day with nutritious meals.",
                    category: "Food Security"
                },
                vocational: {
                    title: "Vocational Training",
                    desc: "Empowering students with hands-on technical skills for a better future.",
                    category: "Education"
                },
                it: {
                    title: "IT Scholarship",
                    desc: "Building the next generation of software developers and digital creators.",
        ...
        zakat: {
            ...
            description: "Purify your wealth by calculating your Zakat accurately. Enter your assets below to see how much you can contribute to those in need.",
            inputs: {
                gold: "Gold (Total Value in PKR)",
                silver: "Silver (Total Value in PKR)",
            ...
            summary: {
                title: "Summary",
                subtitle: "Auto-calculated based on current Nisab rates.",
                netAssets: "Total Net Assets",
                payable: "Total Zakat Payable",
                eligible: "You are eligible to pay Zakat. Your net wealth exceeds the Nisab threshold.",
                notEligible: "You are NOT eligible to pay Zakat. Your net wealth is below the Nisab threshold."
            }
        },
        impact: {
            title: "Join Our Global Supporters",
            description: "Your small contribution today can create a ripple effect that changes a family's life forever. Join thousands of donors making an impact.",
            stats: {
                donors: "Donors",
    ...
    contact: {
        title: "Get in Touch",
        subtitle: "We're here to answer your questions and listen to your feedback. Your voice matters to us.",
        form: {
            ...
            placeholders: {
                ...
                subject: "Welfare inquiry, Donation help, etc.",
                message: "Describe how we can help you..."
            },
            send: "SEND MESSAGE",
            sent: "MESSAGE SENT!"
        },
        info: {
            ...
            whatsapp: "WhatsApp",
            hours: "Working Hours",
            follow: "Follow our updates",
            emergency: "Need Immediate Help?",
            emergencyText: "If you are facing an emergency or require urgent medical aid, please call our 24/7 hotline directly."
        }
    },
    projects: {
        title: "Our Visionary Projects",
        subtitle: "Witnessing the impact of your contributions across Pakistan. Every photo tells a story of hope and transformation.",
        filter: "Filter:",
        noItems: "No items found in this category.",
        transparency: "Transparency is Our Value",
        transparencyText: "We document every project to show you where your money goes. Your trust is our greatest asset.",
        support: "Support a New Project",
        categories: {
            all: "All",
            education: "Education",
            food: "Food",
    ...
    servicesPage: {
        title: "Our Services",
        cta: {
            title: "Want to contribute to our mission?",
            text: "Your support helps us reach more people in need across Pakistan. Join us in making a difference.",
            donate: "Donate to a Project",
            contact: "Contact Us"
        },
        detail: {
            aboutInitiative: "About this Initiative",
            shareCause: "Share this Cause:",
            joinMission: "Join the Mission",
            impactToday: "Make an Impact Today",
            impactDescription: "Your support directly fuels our {{serviceTitle}} initiatives. No contribution is too small for a family in need.",
    ...
    upcomingProjects: {
        ...
        subtitle: "We are expanding our reach to serve more communities. Your support is crucial for these upcoming initiatives.",
        items: [
            {
                title: "Vocational Training Center",
                description: "We aim to establish a modern Vocational Training Center in our area to provide free skill-based training to underprivileged youth. This will help them secure employment and support their families. For this purpose, we need support and funding."
            },
            {
                title: "Rare Foundation Shelter Home Construction",
    ...
    introduction: {
        ...
        subtitle: "Founded in 2011 with a single goal: To serve humanity with integrity, transparency, and compassion.",
        intro: {
            title: "Introduction",
            text1: "<0>Rare Foundation Trust</0> is a non-profit organization working to support the <1>needy, underprivileged, widows, orphans, and deserving families.</1> We believe in serving humanity with sincerity and compassion, and with your support we aim to bring positive change to the lives of thousands",
            text2: "Established on January 1, 2011, <0>Rare Foundation Trust</0> is a well-structured and multifaceted charitable organization dedicated to humanitarian, educational, and socio-economic upliftment across Pakistan.",
            text3: "With a firm commitment to serving the underprivileged, the Foundation works with integrity, transparency, and a deep-rooted sense of responsibility to humanity. we touch thousands of lives through diverse initiatives focused on <1>education, healthcare, clean water access, orphan support and disaster relief</1>"
        },
        mission: {
            title: "Our Mission",
            text: "To empower communities by delivering a comprehensive educational framework that harmonizes religious teachings with modern academic principles. We strive to alleviate poverty and advance self-sufficient communities."
        },
        vision: {
            title: "Our Vision",
            text: "To cultivate a compassionate and equitable society where every individual has access to quality education, essential resources, and opportunities to overcome challenges and achieve their full potential."
        },
        team: {
            ...
            messageModal: {
                ...
                subtitle: "Your message will be sent directly to our leadership team.",
                form: {
        ...
        targets: {
            ...
            text: "Our goal by 2026 is to expand the scope of our welfare initiatives so that education, healthcare, clean water, and family support reach a greater number of deserving families. Through sustainable projects, we are committed to empowering communities, strengthening our Orphan Support Program, providing continuous assistance to vulnerable individuals, and enhancing our emergency response efforts. Our vision is to build a society where every person has equal opportunities to live a dignified life.",
            schools: "New Schools",
            water: "Water Projects",
            shelter: "Shelter for Orphans"
        },
        cta: {
            title: "Become a Part of Our Journey",
            text: "Your support fuels our mission. Join hands with us to create a compassionate Pakistan.",
            button: "Support Our Mission"
        }
    },
    donationModal: {
        title: "Make a Donation",
        subtitle: "Choose your preferred method to support our cause.",
        bankTransfers: "Bank Transfers",
        wallets: "Mobile Wallets",
        titleField: "Title",
        ibanField: "IBAN",
        confirmTitle: "Confirm Your Donation",
        confirmSubtitle: "Already transferred? Upload your receipt for confirmation.",
        form: {
            fullName: "Full Name",
            email: "Email Address",
            amount: "Donation Amount (PKR)",
            purpose: "Purpose of Donation",
            comment: "Additional Comment (Optional)",
            receipt: "Upload Receipt (JPG, PNG)",
    ...
    newsletter: {
        tag: "Monthly Updates",
        title: "Stay Updated with Our Mission",
        subtitle: "Subscribe to our newsletter for latest news, impact stories, and upcoming campaigns.",
    ...
    whatsapp: {
        ...
        message: "Hello Rare Foundation, I would like to inquire about your projects."
    }
};
